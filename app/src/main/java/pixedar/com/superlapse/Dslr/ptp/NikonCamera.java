...
import pixedar.com.superlapse.Dslr.ptp.commands.GetDevicePropDescCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.InitiateCaptureCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.RetrieveAddedObjectInfoAction;
import pixedar.com.superlapse.Dslr.ptp.commands.SimpleCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonAfDriveCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonCloseSessionAction;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonEventCheckCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonGetLiveViewImageAction;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonGetLiveViewImageCommand;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonOpenSessionAction;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonStartLiveViewAction;
import pixedar.com.superlapse.Dslr.ptp.commands.nikon.NikonStopLiveViewAction;
import pixedar.com.superlapse.Dslr.ptp.model.DevicePropDesc;
...
public class NikonCamera extends PtpCamera{
    ...
    private CamerStateListener camerStateListener;
    public NikonCamera(PtpUsbConnection connection, CameraListener listener,Camera.CamerStateListener camerStateListener, WorkerListener workerListener) {
        super(connection, listener, workerListener);
        this.camerStateListener = camerStateListener;
    ...
    public void onPropertyChanged(int property, int value) {
        ...
        if (property == PtpConstants.Property.NikonEnableAfAreaPoint) {
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    for(Camera.CameraListener listener:listeners) {
                        if (listener != null) {
    ...
    private void onPropertyCodesReceived(Set<Integer> properties) {
        ...
        addPropertyMapping(Camera.Property.Compression,PtpConstants.Property.CompressionSetting);
        addPropertyMapping(Camera.Property.ImgeSize,PtpConstants.Property.ImageSize);
        addPropertyMapping(Camera.Property.AfModeSelect,PtpConstants.Property.NikonAFModeSelect);
        addPropertyMapping(Camera.Property.noiseReduction,PtpConstants.Property.NikonNoiseReduction);
        addPropertyMapping(Camera.Property.stillCaptureMode,PtpConstants.Property.StillCaptureMode);
    ...
    public void onSessionClosed() {
        ...
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (camerStateListener!= null) {
                    camerStateListener.onCameraStopped(NikonCamera.this);
                }
            }
        });
    ...
    public void onSessionOpened() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                if (camerStateListener != null) {
                    camerStateListener.onCameraStarted(NikonCamera.this);
                }
            }
        });
    ...
    public void capture() {
        ...
        queue.add(new InitiateCaptureCommand(this,true));
    }
    ...
    @Override
    public void captureNoAf(){
        if (liveViewOpen) {
            queue.add(new NikonStopLiveViewAction(this, false));
        }
        int val = this.getProperty(Property.AfModeSelect);
        this.setProperty(Property.AfModeSelect,0x004);
        queue.add(new InitiateCaptureCommand(this,true));
        this.setProperty(Property.AfModeSelect,val);
    }
    @Override
...
/*    @Override
    ...
    if (supportedOperations.contains(Operation.NikonChangeAfArea)) {
        ...
        queue.add(new SimpleCommand(this, PtpConstants.Operation.NikonChangeAfArea, Math.round(posx*wholeWidth),  Math.round(posx*wholeHeight)));
    }
}
