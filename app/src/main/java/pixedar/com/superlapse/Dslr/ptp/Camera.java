...
public interface Camera {
    public interface CamerStateListener{
        void onCameraStarted(PtpCamera camera);
    ...
    public static class Property {
        ...
        public static final int Compression = 17;
        public static final int ImgeSize = 18;
        public static final int AfModeSelect = 19;
        public static final int noiseReduction =20;
        public static final int stillCaptureMode = 21;
    }
    ...
    public interface CameraListener {
        void onCameraReconnected(PtpUsbConnection connection);
    ...
    public interface StorageInfoListener {
        void onStorageFound(int handle, String label, StorageInfo storageInfo);
