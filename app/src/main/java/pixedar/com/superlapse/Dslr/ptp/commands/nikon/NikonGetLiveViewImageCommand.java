...
public class NikonGetLiveViewImageCommand extends NikonCommand {
    ...
    public NikonGetLiveViewImageCommand(NikonCamera camera, LiveViewData data) {
        super(camera);
//        Log.d("DEBUG", String.valueOf(data.bitmap.getHeight()));
        this.data = data;
        if (data == null) {
    ...
    protected void decodeData(ByteBuffer b, int length) {
        ...
        // read af frame
        {
            if(productId == Product.NikonD3400){
                b.position(start+15);
            }
            ...
            if(productId != Product.NikonD3400) {
                ...
                data.nikonWholeWidth = jpegImageWidth;
                data.nikonWholeHeight = jpegImageHeight;
            }
    ...
    void save(byte[] b,int index) throws IOException {
        File yourFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), String.valueOf(index)+".bin");
